    ...
    <div className="space-y-6 pb-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <motion.div
                ...
                className="p-5 rounded-2xl backdrop-blur-xl bg-gradient-to-br from-white/70 to-white/40 dark:from-slate-700/70 dark:to-slate-700/40 border-2 border-white/40 dark:border-slate-600/40"
              >
      ...
      >
        <div className="flex items-center gap-2 mb-6">
          ...
          <h3 className="text-xl text-slate-800 dark:text-white">7-Day Habit Streaks</h3>
        </div>
