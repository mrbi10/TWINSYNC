...
import { Shield, Database, Bell, Lock, Download, Upload } from 'lucide-react';
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <h4 className="text-sm text-slate-700 dark:text-slate-200">Data Management</h4>
            <div className="flex gap-3">
              <Button 
                variant="outline" 
                className="flex-1 rounded-2xl backdrop-blur-xl bg-white/50 dark:bg-slate-800/50 border border-white/30 dark:border-slate-700/30 hover:bg-white/80 dark:hover:bg-slate-800/80"
              >
